  ...
  return (
    <div className="bg-white p-3.5 rounded-xl border border-border-default space-y-2">
      ...
      <div className="flex items-center gap-2">
        <span className={`text-[10px] font-semibold uppercase tracking-wide max-w-[18%] leading-[14px] shrink-0 ${thumbPercent < 50 ? 'text-brand-primary' : 'text-gray-400'}`}>
          {axis.poleA}
        </span>
        ...
        <span className={`text-[10px] font-semibold uppercase tracking-wide text-right max-w-[18%] leading-[14px] shrink-0 ${thumbPercent > 50 ? 'text-brand-primary' : 'text-gray-400'}`}>
          {axis.poleB}
        </span>
      </div>
    </div>
