...
const txContests: Contest[] = [
  ...
  },
  {
    ...
    termInfo: 'Your U.S. Representative votes on federal laws like taxes, healthcare, and the budget. TX-34 covers the Rio Grande Valley, where border policy, trade, and healthcare are top issues.',
    votingFor: 1,
  ...
  },
  {
    ...
    jurisdiction: 'federal',
    officeRef: 'us_representative_federal',
    termInfo: 'Your U.S. Representative votes on federal laws like taxes, healthcare, and the budget. TX-28 runs from San Antonio to Laredo along the border, where trade, border policy, and energy are top issues.',
    votingFor: 1,
