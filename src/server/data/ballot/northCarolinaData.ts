...
const ncContests: Contest[] = [
  {
    ...
    termInfo: 'Open seat. North Carolina\'s next U.S. Senator will vote on picking judges, the federal budget, and healthcare. This seat helps decide which party controls the Senate.',
    votingFor: 1,
  ...
  },
  {
    ...
    termInfo: 'Your U.S. Representative votes on federal laws like taxes, healthcare, and the budget. NC-02 covers most of Wake County, including Raleigh.',
    votingFor: 1,
  ...
  },
  {
    ...
    jurisdiction: 'state',
    termInfo: 'This State Senator votes on the state budget, school funding, and health programs. The district covers the coast and rural areas. Key issues here include storm prep, coastal growth, and access to doctors.',
    votingFor: 1,
