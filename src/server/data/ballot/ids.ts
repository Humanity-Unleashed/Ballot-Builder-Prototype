...
export const BALLOT_IDS = {
  ...
  TX_AUSTIN_2026: 'tx-austin-2026-general',
} as const;
...
export const CONTEST_IDS = {
  ...
  TX_HOUSE_37: 'TX-US-HOUSE-37-2026',
  TX_LT_GOVERNOR: 'TX-LT-GOVERNOR-2026',
  TX_COMPTROLLER: 'TX-COMPTROLLER-2026',
  TX_LAND_COMMISSIONER: 'TX-LAND-COMMISSIONER-2026',
  TX_AG_COMMISSIONER: 'TX-AG-COMMISSIONER-2026',
  TX_RAILROAD_COMMISSIONER: 'TX-RAILROAD-COMMISSIONER-2026',
} as const;
